  ...
  return (
    <div className="intro-components">
      ...
      <div>
        ...
        />
        <button onClick={props.onClick}>Ввести</button>
      </div>
    </div>
  );
}
...
class App extends React.Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      class: "container",
      bracket4: {
        mainColumn: "25% 25% 25% 25%",
        column: [1, 1, 4, 4, 2, 3],
        row: [2, 4, 2, 4, 3, 3],
        match: [4, 4, 5, 5],
        mainRow: "25% 25% 25% 25% 25%"
      },
      bracket8: {
  ...
  handleChange(e) {
    ...
    if (newNum === "4") {
      ...
      this.setState({
        names: Array(6).fill(),
        class: "bracket4",
        isClicked: Array(6).fill("#cdcd")
      });
    }
    if (newNum === "8") {
      this.setState({
        names: Array(14).fill(),
        isClicked: Array(14).fill("#cdcd")
      });
    }
    if (newNum === "16") {
      this.setState({
        names: Array(30).fill(),
        isClicked: Array(30).fill("#cdcd")
      });
    }
  }
